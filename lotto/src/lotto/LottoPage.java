...
///////////////왼쪽 버튼 세개 생성///////////////////////////////////////////////////
		...
		btnAuto.putClientProperty("choiceType", "Auto");
		ImageIcon imageAuto = new ImageIcon("images/random.jpg");
		btnAuto.setIcon(imageAuto);
		btnAuto.setContentAreaFilled(false); // 버튼의 기본 모양 숨기기
		btnAuto.setBorderPainted(false);
		btnAuto.setFont(new Font("굴림", Font.PLAIN, 20));
		btnAuto.setBounds(40, 183, 173, 113);
		...
		for (int i = 0; i < 45; i++) {
			...
			buttons.get(i).addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (choiceType == "HalfSelf" && numbers.size() == 5) {

						JOptionPane.showMessageDialog(null, "5개 초과 선택은 할 수 없습니다.", "반자동 선택",
								JOptionPane.INFORMATION_MESSAGE);
...
/////////////구매 버튼 클릭시////////////////////////////////////////////////////	
		btnBuy.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				for (int j = 0; j < 5; j++) { // 버튼 클릭시 비활성화 되게 할려했ㄷ ㅔ 몇ㄹ시간동안 안되서 포
